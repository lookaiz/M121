...
// Finally, the air_alliances collection will show the airlines
// that are in each alliance, with this schema:
{
...
// with at most one layover, departing from the base airports of airlines
// that make part of the "OneWorld" alliance.
...
// **************************************** //
2nd query => ???
This answer does not take into account countries (Spain, Germany or Canada)
// **************************************** //
var airlines = [];
...
// **************************************** //
3rd query => 745 destinations
This query does not take into account countries (Spain, Germany or Canada)
// **************************************** //
...
db.air_routes.aggregate(pipeline).itcount()

// **************************************** //
4th query => 450 destinations
// **************************************** //
var pipeline = [
    {
...
db.air_airlines.aggregate(pipeline).itcount()
